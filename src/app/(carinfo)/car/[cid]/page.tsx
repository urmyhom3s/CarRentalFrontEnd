...
export default async function CarDetailPage(
  ...
  />
      <div className="text-base mx-5 text-left">
        <div className="text-base mx-5">{carDetail.data.description}
        ...
        <div className="text-base mx-5">Daily Rental Rate: {carDetail.data.dayRate} (insurance included)</div>
...
export async function generateStaticParams() {
  return [
    { cid: '001' },{ cid: '002' },{ cid: '003' },{ cid: '004' }
  ]
}