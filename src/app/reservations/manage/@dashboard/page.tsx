            ...
            {profile.data.role === "admin" ? (
                <form action={addCar}>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type="number" required id="seats" name="seats"
                            placeholder="4" min={0} max={50}
                        ...
                        <input type="number" required id="doors" name="doors"
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type="number" required id="largebags" name="largebags"
                        ...
                        <input type="number" required id="smallbags" name="smallbags"
                            placeholder="2" min={0} max={10}
                            className="bg-white border-2 border-gray-200 rounded w-auto p-2
                                       text-gray-700 focus:outline-none focus:border-blue-400"/>
                    </div>
